/*
https://www.codewars.com/kata/59f82e2effe75f10f600006f/csharp
...
For example, John, a businessman, brought in some goods each cost him $40 and he decided to sell at the price of $70. 
Then a customer came to buy one, gave John $100, and of course got back $30.
...
In this case John lost $20: John received $40 true money and $50 fake money, then paid back $20 true money to the customer. 
He has $20 true money left, but the cost price of good is $40, so he lost $20.
...
namespace CodeWars
{
    public class SimpleFun372LoseOrEarn
    {
        public static string LoseOrEarn(int costPrice, int sellPrice, int fakeMoney, int paidBack)
        {
            var lost = sellPrice - fakeMoney - costPrice;
            return lost < 0 ? $"Lost ${-lost}" : $"Earned ${lost}";
            //return $"{(lost < 0 ? "Earned" : "Lost")} ${Math.Abs(lost)}";
        }
    }
}