/*
https://www.codewars.com/kata/59fb4d89ff58e5e816002efc/csharp
...
Documentation:
Kata.MakesTheSentence Method (List<Char>, String)
...
public static bool MakesTheSentence(
...
Parameters
characters
Type: System.Collections.Generic.List<char>
...
Return Value
Type: System.Boolean
True if sentence can be made up of characters from characters else false.
*/
...
namespace CodeWars
{
    public class MakesSentence
    {
        public static bool MakesTheSentence(List<char> characters, string sentence)
        {
            return sentence.Where(c => c != ' ').OrderBy(c => c)
                .SequenceEqual(characters.Where(c => !char.IsDigit(c)).OrderBy(c => c));
        }
    }
}