/*
https://www.codewars.com/kata/55c9a8cda33889d69e00008b/csharp
...
namespace CodeWars
{
    ...
    {
        private static readonly Dictionary<string, string> DrunkenDoodling = new Dictionary<string, string>
        {
            {"werewolf", "Silver knife or bullet to the heart"},
            {"vampire", "Behead it with a machete"},
            {"wendigo", "Burn it to death"},
        ...
        {
            // Thanks to years of hard work and research, there's a Dictionary<string, string> on this class you can access with "DrunkenDoodling"
            // Feel free to use it to solve this Kata.

            // return DrunkenDoodling.ContainsKey(monsterName)
            //     ? $"{DrunkenDoodling[monsterName]}, idjits!"
            //     : "I have friggin no idea yet, idjits!";


            // if (DrunkenDoodling.TryGetValue(monsterName, out var val))
            //     return val + ", idjits!";
        ...
        public static string Bob1(string monsterName) => (DrunkenDoodling.ContainsKey(monsterName)
            ? DrunkenDoodling[monsterName]
            : "I have friggin no idea yet") + ", idjits!";
    }
}