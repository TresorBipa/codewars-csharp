/*
https://www.codewars.com/kata/58a651ff27f95429f80000d0//csharp
...
namespace CodeWars
{
    public class SimpleFun131LearnCharitableGame
    {
        public bool LearnCharitableGame(int[] arr)
        {
            return arr.Sum() > 0 && arr.Sum() % arr.Length == 0;
            //return arr.Sum() != 0 && arr.Sum() % arr.Length == 0;
            //return arr.ToList().Sum() > 0 && arr.ToList().Sum() % arr.Length == 0;
        }
    }
}