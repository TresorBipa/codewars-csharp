/*
https://www.codewars.com/kata/588475d575431d0a0e000023/csharp
...
namespace CodeWars
{
    public class SimpleFun19CountBlackCells
    {
        private static int Gcd(int a, int b) => b == 0 ? a : Gcd(b, a % b);
        public static int CountBlackCells(int h, int w) => h + w + Gcd(h, w) - 2;
    }
}