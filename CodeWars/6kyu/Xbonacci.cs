/*
https://www.codewars.com/kata/556e0fccc392c527f20000c5/csharp
...
namespace CodeWars
{
    public class Xbonacci
    {
        public double[] xbonacci(double[] signature, int n)
        {
            ...
            // for (var i = len; i < n; i++)
            // result.Add(result.TakeLast(len).Sum());
            // result.Add(result.GetRange(i, len).Sum());
            // result.Add(result.Skip(i - signature.Length).Sum());
