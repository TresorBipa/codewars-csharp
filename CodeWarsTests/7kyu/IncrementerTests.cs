...
{
    [TestFixture]
    public class KataIncrementerTests
    {
        ...
        [TestCase(new int[] {1, 2, 3, 4, 5, 6, 7, 8, 9, 9, 9, 9, 9, 8},
            new int[] {2, 4, 6, 8, 0, 2, 4, 6, 8, 9, 0, 1, 2, 2})]
    ...
    static class Tester
    {
        ...
        {
            var actual = KataIncrementer.Incrementer(numbers.ToArray());
            var msg =
                $"Invalid answer for numbers: {ArrayToString(numbers)}\n\texpected: {ArrayToString(expected)}\n\tactual: {ArrayToString(actual)}";
